<x-app-layout>
    ...
    <section class="px-6 py-20 mx-auto text-center md:px-16 max-w-7xl">
      ...
      <div class="grid grid-cols-1 gap-10 md:grid-cols-3">
        <!-- Feature Card 1 -->
        <div class="p-10 overflow-hidden transition-all bg-white border border-gray-200 shadow-xl rounded-3xl hover:shadow-2xl">
    ...
    <section class="px-6 py-20 mx-auto text-center text-white md:px-16 max-w-7xl bg-darkNeutral">
      ...
      <p class="text-lg md:text-xl">
        Our AI-powered diagnostic system is trained on millions of cases to ensure <strong>highly accurate predictions</strong> and <strong>real-time insights</strong>.
      </p>
    </section>
      ...
      <div class="grid grid-cols-1 gap-10 md:grid-cols-3">
        <div class="p-10 transition-all bg-white border border-gray-200 shadow-xl rounded-3xl hover:shadow-2xl">
          <p class="text-lg text-gray-600">
            "Pulmo-Vantage has revolutionized our approach to lung health. Their AI insights are truly remarkable."
          </p>
          <div class="mt-4">
    ...
    <section class="px-6 py-20 mx-auto text-center md:px-16 max-w-7xl bg-primary text-neutral">
      ...
      <a href="/join" class="px-8 py-3 font-semibold text-white transition-all duration-300 rounded-lg shadow-md bg-secondary hover:bg-opacity-90">
        Get Started
      </a>
    </section>
  </x-app-layout>
