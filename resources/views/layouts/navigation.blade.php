        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('admin.api-configs.index')" :active="request()->routeIs('admin.api-configs.*')">
                        {{ __('API Configs') }}
                    </x-nav-link>
                </div>
            </div>
                        ...
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                <button onclick="setTheme('default')"
                                    ...
                                    <span class="inline-block w-4 h-4 mr-2 rounded-full"
                                        style="background-color: #3F51B5;"></span>
                                    Default
                                </button>
                                <button onclick="setTheme('theme-warm')"
                                    class="block w-full px-4 py-2 text-sm text-left text-gray-700 hover:bg-gray-100">
                                    <span class="inline-block w-4 h-4 mr-2 rounded-full"
                                        style="background-color: #FF5722;"></span>
                                    Warm
                                </button>
                                ...
                                <button onclick="setTheme('theme-teal')"
                                    class="block w-full px-4 py-2 text-sm text-left text-gray-700 hover:bg-gray-100">
                                    <span class="inline-block w-4 h-4 mr-2 rounded-full"
